...
Call log:
  - waiting for getByRole('button', { name: /^Seat .+ available$/ }).first()
        ...
        - tabpanel "lower deck" [ref=e42]:
          ...
          - generic [ref=e44]:
            - button "Seat S1 booked" [disabled] [ref=e45]:
              - generic [ref=e46]: S1
            - button "Seat S2 booked" [disabled] [ref=e47]:
              - generic [ref=e48]: S2
            - button "Seat S3 booked" [disabled] [ref=e49]:
              - generic [ref=e50]: S3
            - button "Seat S4 booked" [disabled] [ref=e51]:
              - generic [ref=e52]: S4
            - button "Seat S5 booked" [disabled] [ref=e53]:
              - generic [ref=e54]: S5
            - button "Seat S6 booked" [disabled] [ref=e55]:
              - generic [ref=e56]: S6
            - button "Seat S7 ladies" [ref=e57] [cursor=pointer]:
              - generic [ref=e58]: S7
            - button "Seat S8 booked" [disabled] [ref=e59]:
              - generic [ref=e60]: S8
            - button "Seat S9 booked" [disabled] [ref=e61]:
              - generic [ref=e62]: S9
            - button "Seat S10 booked" [disabled] [ref=e63]:
              - generic [ref=e64]: S10
            - button "Seat S11 booked" [disabled] [ref=e65]:
              - generic [ref=e66]: S11
            - button "Seat S12 booked" [disabled] [ref=e67]:
              - generic [ref=e68]: S12
            - button "Seat S13 booked" [disabled] [ref=e69]:
              - generic [ref=e70]: S13
            - button "Seat S14 ladies" [ref=e71] [cursor=pointer]:
              - generic [ref=e72]: S14
            - button "Seat S15 booked" [disabled] [ref=e73]:
              - generic [ref=e74]: S15
            - button "Seat S16 booked" [disabled] [ref=e75]:
              - generic [ref=e76]: S16
            - button "Seat S17 booked" [disabled] [ref=e77]:
              - generic [ref=e78]: S17
            - button "Seat S18 booked" [disabled] [ref=e79]:
              - generic [ref=e80]: S18
            - button "Seat S19 booked" [disabled] [ref=e81]:
              - generic [ref=e82]: S19
            - button "Seat S20 booked" [disabled] [ref=e83]:
              - generic [ref=e84]: S20
            - button "Seat S21 booked" [disabled] [ref=e85]:
              - generic [ref=e86]: S21
            - button "Seat S22 booked" [disabled] [ref=e87]:
              - generic [ref=e88]: S22
            - button "Seat S23 booked" [disabled] [ref=e89]:
              - generic [ref=e90]: S23
            - button "Seat S24 booked" [disabled] [ref=e91]:
              - generic [ref=e92]: S24
            - button "Seat S25 booked" [disabled] [ref=e93]:
              - generic [ref=e94]: S25
            - button "Seat S26 booked" [disabled] [ref=e95]:
              - generic [ref=e96]: S26
            - button "Seat S27 booked" [disabled] [ref=e97]:
              - generic [ref=e98]: S27
            - button "Seat S28 ladies" [ref=e99] [cursor=pointer]:
              - generic [ref=e100]: S28
            - button "Seat S29 booked" [disabled] [ref=e101]:
...
```ts
  ...
  7  |     const seat = this.page.getByRole('button', { name: /^Seat .+ available$/ }).nth(index);
> 8  |     await seat.click();
     |                ^ TimeoutError: locator.click: Timeout 15000ms exceeded.
  9  |     await expect(seat).toHaveAttribute('aria-pressed', 'true');
  10 |   }
  11 | 
  12 |   async continueToPassengerDetails(): Promise<void> {
  13 |     await this.page.getByRole('button', { name: 'Continue to passenger details' }).click();
  14 |     await expect(this.page).toHaveURL(/\/book\/passenger/);
  15 |   }
  16 | }
  17 | 
```