...
public class AuthTest extends BaseApiTest {
    ...
    void login_shouldReturn200() {
        ...
        Response response =
                given()
                        ...
                        .body("token", notNullValue(), "user.email", equalTo(TestConfig.EMAIL
                                ),
    ...
    @DisplayName(
            "Login should fail for invalid email"
    )
    ...
    @DisplayName(
            "OAuth invalid secret should return 401"
    )
