...
public class OrdersTest
    ...
    private void addItemToCart() {
        ...
        given()
                ...
                .spec(
                        RequestSpecs.authenticatedSpec(
                                Auth.loginToken()
                        )
                )
                ...
                .body(
                        ...
                        new CartModels.AddCartItemRequest(
    ...
    void createOrder_shouldReturn201() {
        ...
        OrderModels.CreateOrderRequest request =

                new OrderModels.CreateOrderRequest(
    ...
    @DisplayName(
            "Create order with empty cart should return 400"
    )
    void emptyCart_shouldReturn400() {
        ...
        given()
                ...
                .spec(
                        ResponseSpecs.badRequest400Spec()
                )
    ...
    @DisplayName(
            "Fetch orders should return 200"
    )
    ...
    @DisplayName(
            "Fetch invalid order should return 404"
    )
    ...
    @DisplayName(
            "Create secure order should return 201"
    )
        ...
        Response response =
                ...
                given()
                        ...
                        .body(
                                ...
                                new OrderModels.SecureOrderRequest(
    ...
    @DisplayName(
            "Viewer token should return 403"
    )
    void viewerCannotCreateSecureOrder() {
        ...
        given()
                ...
                .spec(
                        ResponseSpecs.forbidden403Spec()
                );
    ...
    @DisplayName(
            "Ship without allocate should return 409"
    )
