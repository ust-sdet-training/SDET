...
public class OrdersTest extends BaseApiTest {
    ...
    @Test
    @DisplayName("Create order return 201")
    ...
    @Test
    @DisplayName("Create order with empty cart return 400")
    ...
    @Test
    @DisplayName("Fetch orders return 200")
    ...
    @Test
    @DisplayName("Fetch invalid order return 404")
    ...
    @Test
    @DisplayName("Create secure order return 201")
    ...
    @Test
    @DisplayName("Viewer token return 403")
    ...
    @Test
    @DisplayName("Expired token return 401")
    ...
    @Test
    @DisplayName("Ship without allocate return 409")
    ...
    @Test
    @DisplayName("Partner order return 200")
    void partnerOrder_shouldReturn200() {

        given()
                .header("x-api-key",TestConfig.RETAIL_API_KEY)
                .when()
                .get("/api/partner/orders/5001")
                .then()
                .spec(ResponseSpecs.ok200Spec())
