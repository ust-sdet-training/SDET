...
public class CartTest extends BaseApiTest {
    ...
    @Test
    @DisplayName("Add item to cart  return 201")
    ...
    @Test
    @DisplayName("Get cart  return 200")
    ...
    @Test
    @DisplayName("Update cart item return 200")
    ...
    @Test
    @DisplayName("Delete cart item return 204")
    ...
    @Test
    @DisplayName("Unauthorized cart access  return 401")
    ...
    @Test
    @DisplayName("Invalid quantity return 400")
    ...
    @Test
    @DisplayName("Quantity exceeds stock return 409")
