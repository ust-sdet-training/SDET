...
public class ProductsTest
    ...
    @DisplayName(
            "Fetch products should return 200"
    )
                ...
                given()
                        ...
                        .body(
                                ...
                                matchesJsonSchemaInClasspath(
                                        ...
                                        "schemas/json/products-schema.json"
    ...
    @DisplayName(
            "Fetch single product should return 200"
    )
    ...
    @DisplayName(
            "Search products should return filtered result"
    )
    ...
    @DisplayName(
            "Legacy XML product should return valid XML"
    )
    void xmlProduct_shouldReturn200()
            throws Exception {
        ...
        String xml =
                ...
                given()
                        ...
                        .spec(
                                RequestSpecs.xmlRequestSpec()
                        )

                        .when()

                        .get(
                                "/api/legacy/products/101.xml"
                        )

                        .then()

                        .spec(
                                ResponseSpecs.xml200Spec()
                        )
        ...
        InputStream xsd =
                ...
                getClass()
                        ...
                        .getResourceAsStream(
                                ...
                                "schemas/xsd/product-schema.xsd"
    ...
    @DisplayName(
            "Invalid XML product should return 404"
    )
