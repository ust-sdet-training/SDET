...
public class ProductsTest extends BaseApiTest {
    ...
    @Test
    @DisplayName("Fetch products should return 200")
    ...
    @Test
    @DisplayName("Fetch single product should return 200")
    ...
    @Test
    @DisplayName("Search products should return filtered result")
    ...
    @Test
    @DisplayName("Category filter should return products")
    ...
    @Test
    @DisplayName("Invalid product id should return 404")
    ...
    @DisplayName("Legacy XML product should return valid XML")
    ...
    @Test
    @DisplayName("Invalid XML product should return 404")
