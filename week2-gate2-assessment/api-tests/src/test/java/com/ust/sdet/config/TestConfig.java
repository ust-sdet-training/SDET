...
public final class TestConfig {
    ...
    public static final String ADMIN_EMAIL = TestEnvironment.optional("ADMIN_EMAIL", "admin@example.com");

    public static final String ADMIN_PASSWORD = TestEnvironment.optional("ADMIN_PASSWORD", "Password@123");
