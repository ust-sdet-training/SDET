...
public class NegativeAssertionsTest {
    ...
    @Test
    @DisplayName("Checking for missingToken 401")
    ...
    @Test
    @DisplayName("Checking invalidToken 401")
    ...
    @Test
    @DisplayName("Checking with Wrong Role 403")
    ...
    @Test
    @DisplayName("Creating a order with expired token 401")
    void expired_token() {
    ...
    @Test
    @DisplayName("Checking Unknown Order 404")
    void unknown_order() {
    ...
    @Test
    @DisplayName("Check for conflict status 409")
