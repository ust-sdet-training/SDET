...
import com.ust.sdet.api.DbFramework.Repository.OrderRepo;
...
public class CreateOrderTest {
    ...
    @Test
    @DisplayName("DataBase (MySQL) is reachable through JDBC")
    ...
    void shouldCreateOrderAndValidateDatabase() throws SQLException {
        ...
        Response response =
                given()
                        ...
                        .body(matchesJsonSchemaInClasspath("schemas/json/OrdersSchema/Partner.schema.json"))
                        .extract()
                        .response();
        ...
        DbAssertions.assertOrderStatus(
                dbOrder,
                response.jsonPath().getString("status")
        );

        DbAssertions.assertOrderNumber(
                dbOrder,
