package com.ust.sdet.Api_Framework.specs;

import com.ust.sdet.Api_Framework.config.AuthenticationConfig;
...
public final class SpecFactory {
    ...
    public static RequestSpecification customerRead(String token) {
        return new RequestSpecBuilder()
                .setAccept(ContentType.JSON)
                .addHeader("Authorization", bearer(token))
                .addHeader("X-Cart-Session", AuthenticationConfig.CART_SESSION)
                .build();
    }
    ...
    public static String getOAuthToken() {
        return getToken(
                AuthenticationConfig.OPS_CLIENT_ID,
                AuthenticationConfig.OPS_CLIENT_SECRET
        );
    }

    public static String getViewerToken() {
        return getToken(
                AuthenticationConfig.VIEWER_CLIENT_ID,
                AuthenticationConfig.VIEWER_CLIENT_SECRET
        );
    }

    public static String getExpiredToken() {
        return getToken(
                AuthenticationConfig.EXPIRED_CLIENT_ID,
                AuthenticationConfig.EXPIRED_CLIENT_SECRET
        );
    }
