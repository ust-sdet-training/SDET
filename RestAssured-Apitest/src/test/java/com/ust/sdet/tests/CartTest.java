...
public class CartTest extends BaseApiTest {
    ...
    @Test
    @DisplayName("Add item to cart returning 201")
    ...
    @Test
    @DisplayName("Get cart returns 200")
    ...
    @Test
    @DisplayName("Update cart item returns 200")
    ...
    @Test
    @DisplayName("Unauthorized cart return 401")
    void unauthorized_shouldReturn401() {
        given()
                .spec(RequestSpecs.authenticatedSpec(Auth.invalidToken()))
                .when()
                .get("/api/cart")
                .then()
    ...
    @Test
    @DisplayName("Invalid product return 404")
    ...
    @Test
    @DisplayName("Quantity exceed stock return 409")
