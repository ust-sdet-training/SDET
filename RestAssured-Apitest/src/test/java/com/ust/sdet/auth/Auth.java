...
public final class Auth {
    ...
    public static String oauthToken() {
        ...
        return oauth(new AuthModels.OAuthRequest(
                        TestConfig.GRANT_TYPE,
    ...
    public static String viewerOauthToken() {
        ...
        return oauth(new AuthModels.OAuthRequest(
                        TestConfig.GRANT_TYPE,
                        TestConfig.VIEWER_CLIENT_ID,
                        TestConfig.VIEWER_CLIENT_SECRET
                )
        );
    }
    ...
    public static String expiredOauthToken() {
        ...
        return oauth(new AuthModels.OAuthRequest(
                        TestConfig.GRANT_TYPE,
                        TestConfig.EXPIRED_CLIENT_ID,
                        TestConfig.EXPIRED_CLIENT_SECRET
                )
        );
    }

    private static String oauth(
            AuthModels.OAuthRequest request
    ) {
        return given()
                ...
                .formParam("client_secret", request.getClientSecret()).when()
