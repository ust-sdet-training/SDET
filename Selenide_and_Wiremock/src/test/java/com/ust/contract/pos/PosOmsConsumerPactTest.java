...
import static com.ust.contract.pos.OmsClient.Order;
...
public class PosOmsConsumerPactTest {
    ...
    void testGetMissing(MockServer mockServer) {
        ...
        var order = new OmsClient(mockServer.getUrl()).get400(203);
        assertEquals(404, order.statusCode());
    }
    ...
    void testGetOrder(MockServer mockServer) {
        var order = new OmsClient(mockServer.getUrl()).get200(123);
