...
public class SecurityAuthorizationTest extends JourneyBaseTest {
    ...
    public void userCannotAccessOtherUsersBooking() {
        ...
        var searchResponse = busService.searchBuses(configManager.getFrom(), configManager.getTo(), java.time.LocalDate.now().plusDays(configManager.getTravelOffsetDays()).format(java.time.format.DateTimeFormatter.ISO_LOCAL_DATE));
