...
public class ReservationIntegrationTest extends JourneyBaseTest {
    @Test
    public void integrationFlowShouldReachTheService() {
        login();
        ...
        assertNotNull(response, "The integration path should reach the API");
    }
}
