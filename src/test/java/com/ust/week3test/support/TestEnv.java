...
public class TestEnv {
    ...
    public static String required(String name) {
        ...
        if (value == null) {
            throw new IllegalStateException("Missing " + name + ". Set it in the IntelliJ run configuration or in .env. " + "Working directory: " + Path.of("").toAbsolutePath() + ". Loaded .env: " + loadedEnvFile());
        }
        return value;
    }
    ...
    private static Path findEnvFile() {
        ...
        try {
            Path codeLocation = Path.of(
                    TestEnv.class.getProtectionDomain().getCodeSource().getLocation().toURI()
