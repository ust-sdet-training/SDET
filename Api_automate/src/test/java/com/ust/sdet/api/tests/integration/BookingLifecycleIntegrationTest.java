 ...
 * Journey: One-way flight LKO → DEL, +20 days, economy class
 */
...
public class BookingLifecycleIntegrationTest extends BaseTest {
    ...
    public void completeFlightBookingLifecycleWithDatabaseVerification() {
        ...
        int expectedEmpId = 1013;  // E13 Justin employee ID
        ...
        Flight targetFlight = flights.stream()
                ...
                .findFirst()
                .orElseThrow(() -> new AssertionError("No flights available for LKO → DEL route"));
